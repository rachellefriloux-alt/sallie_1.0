...
class TaskOrchestrator {
    ...
    fun addTask(id: String, title: String, urgency: Int, importance: Int, stressImpact: Int = 1, effortMinutes: Int): Task {
        val t = Task(id, title, urgency, importance, stressImpact, effortMinutes)
        taskPool.add(t)
        return t
    }
