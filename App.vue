  ...
  <div id="app">
    ...
    <div v-else>
      <div class="scenario-bar">
        <button @click="respondToUser(userProfile.name, 'stressed')">Stressed</button>
        <button @click="respondToUser(userProfile.name, 'focused')">Focused</button>
        <button @click="respondToUser(userProfile.name, 'overwhelmed')">Overwhelmed</button>
        <button @click="respondToUser(userProfile.name, 'conflict')">Conflict</button>
        <button @click="respondToUser(userProfile.name, 'celebration')">Celebration</button>
        <button @click="respondToUser(userProfile.name, 'creative')">Creative</button>
        <button @click="respondToUser(userProfile.name, 'reflective')">Reflective</button>
        <button @click="respondToUser(userProfile.name, 'repair')">Repair</button>
        <button @click="respondToUser(userProfile.name, 'choose')">Choose</button>
        <button @click="respondToUser(userProfile.name, 'support')">Support</button>
        <button @click="respondToUser(userProfile.name, 'motivate')">Motivate</button>
        <button @click="respondToUser(userProfile.name, 'soothe')">Soothe</button>
        <button @click="respondToUser(userProfile.name, 'clarify')">Clarify</button>
      </div>
      <emotion-overlay :emotion="emotion" :message="emotionMessage" />
      <insight-card :insight="insight" />
      <voice-console v-if="hasFullAccess" />
      <task-panel v-if="hasFullAccess" :tasks="tasks" />
    </div>
  </div>
</template>
