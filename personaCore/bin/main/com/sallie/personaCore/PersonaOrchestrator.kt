...
class PersonaOrchestrator {
    ...
    fun validatePersonaIntegrity(response: PersonalizedResponse): PersonaValidationResult {
        ...
        if (response.shouldHaveSignature && !response.content.endsWith("Got it, love.") && 
            !response.content.contains("Got it, love")) {
    ...
    private fun personalizeResponse(
        ...
        val shouldHaveSignature = !content.endsWith("Got it, love.") && 
            (templateResponse.contains("Got it, love") || tone.warmth > 0.6f)
